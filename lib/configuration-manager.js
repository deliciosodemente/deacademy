...
export class ConfigurationManager {
    ...
    detectEnvironment() {
        ...
        // Detect based on hostname (browser only)
        ...
        // Default to development for Node.js environment
        return 'development';
    }
    ...
    loadEnvironmentConfig() {
        const baseConfig = {
            ...
            features: {
                ...
                mongodb: this.getFeatureFlag('mongodb', false), // Temporalmente deshabilitado
